REM ==========================================================
REM Resolve repo root from this script location (path-proof)
REM ==========================================================
set "REPO_ROOT=%~dp0"
if "%REPO_ROOT:~-1%"=="\" set "REPO_ROOT=%REPO_ROOT:~0,-1%"

set "INTERNAL_DIR=%REPO_ROOT%\_internal"
set "CORE_PS1=%INTERNAL_DIR%\Install-FirewallCore.ps1"

if not exist "%CORE_PS1%" (
  echo [FATAL] Missing core installer: "%CORE_PS1%"
  echo [HINT] Repo root resolved to: "%REPO_ROOT%"
  exit /b 1
)
